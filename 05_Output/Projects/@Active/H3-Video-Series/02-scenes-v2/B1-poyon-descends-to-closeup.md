...
integrated_multimodal_description: [Shot 1] 3D CG, claymation-style character render, a single continuous shot begins in the wide framing shown in <Picture 1>, with the chick character, the egg-shaped character, and the tiger character standing together against the white background, all three looking upward at the transparent, jelly-like rubber character as it hangs partway into frame from above. All three characters keep their exact appearance and design from <Picture 1> unchanged throughout. The transparent character drops the rest of the way down at a brisk, energetic pace while the camera simultaneously pushes in toward it, in one swift, continuous, unbroken move — quicker than a slow drift but still smooth and readable, covering the full distance from the wide shot to an extreme close-up in a few seconds. As the camera rushes in, the three characters below quickly slide out of frame at the bottom and sides, no longer visible, while the transparent character's glossy round surface rapidly fills more and more of the frame. Its interior gumballs always settle naturally at the bottom of its body under gravity, never floating motionless in mid-air or appearing stuck together, rolling and jostling against each other and the inner wall as it drops, along with the confetti shifting inside without ever spilling out, and its round, dark eyes and flat, outline-only mouth grow larger very quickly within the frame as the camera rushes nearer. By the end of the shot, the transparent character's face fills the entire frame in an extreme close-up, its round eyes, gently curved outline mouth, and soft blush cheeks surrounded by the colorful gumballs and confetti pressing close behind its glossy surface, matching the framing shown in <Picture 2> exactly.
...
integrated_multimodal_description: [Shot 1] 3D CG, claymation-style character render, a single continuous shot begins in the wide framing shown in <Picture 1>, with the chick character, the egg-shaped character, and the tiger character standing together against the white background, all three looking upward with growing excitement at the transparent, jelly-like rubber character as it hangs partway into frame from above, wiggling playfully. All three characters keep their exact appearance and design from <Picture 1> unchanged throughout. For most of the shot, the camera holds almost still in this wide framing, lingering on the three characters' excited, anticipating faces and the transparent character's playful wiggle, building a sense of "something fun is about to happen." Then, in one sudden burst, the camera whips forward rapidly toward the transparent character in a fast, energetic push, covering the entire remaining distance in a flash. In this same instant, the transparent character rushes the rest of the way down to meet the camera. The three characters below vanish out of frame in a blur as the transparent character's glossy round surface rushes to fill the whole frame, its interior gumballs always settling naturally at the bottom of its body under gravity, never floating motionless in mid-air or appearing stuck together, jostling energetically against each other and the inner wall along with the confetti, without ever spilling out. The shot lands sharply on the transparent character's face in an extreme close-up, its round eyes, gently curved outline mouth, and soft blush cheeks surrounded by the colorful gumballs and confetti pressing close behind its glossy surface, matching the framing shown in <Picture 2> exactly.
