...
> **2026-09-09時点でこのカットは廃止・分割済み**。生成時、起き上がる途中でたまちゃんの顔が
> 崩れる問題が発生したため、以下の2カットに分割した:
> - `C2a-tamachan-gets-back-up.md`(起き上がり。実画像でラストフレームをアンカー)
> - `C2b-tamachan-confident-tackle-both-fall-laugh.md`(目が合う→体当たり→2人とも転がって大笑い)
>
> このファイルは経緯の記録として残す。以降はC2a/C2bを使うこと。
