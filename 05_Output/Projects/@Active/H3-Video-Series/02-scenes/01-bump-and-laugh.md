...
overall_soundscape: A soft rubbery squeak echoes at extreme close range as the transparent character makes two small bounces in place, with the light clatter of gumballs shifting inside it each time. A bigger springy bounce sound builds as it launches backward through the air, followed by a soft startled gasp from the egg character just before a muffled, springy thud marks the impact. The egg character's momentum then carries it into a continuous tumbling roll across the floor, producing a rhythmic series of soft thuds as it turns over again and again before slowing to a stop. Both characters produce bright, breathy toddler-like giggles as the scene ends.
