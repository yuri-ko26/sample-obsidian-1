> Source: MiniMax H3 official prompt guide (`VIDEO_PROMPT_WRITING_GUIDE_ref_en.md`, https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/docs/VIDEO_PROMPT_WRITING_GUIDE_ref_en.md).
